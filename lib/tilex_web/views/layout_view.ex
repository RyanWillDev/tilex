...
#  end
  ...
  def twitter_description(_post) do
    """
    TIL is an open-source project orgiinally created by Hashrocket that exists to catalogue the sharing & accumulation of knowledge as it happens day-to-day. 
    """
  end
